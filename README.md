...
- `shortest_path.py`: Dijkstra / Bellman–Ford / Warshall–Floyd
...
含まれます。標準入出力の形式別用例と、NumPyが利用可能な試験環境向けの密行列演算、
行列累乗、法付き演算、連立一次方程式の注意点に加え、Sorted Containersの主要API・
計算量・用途別の使い分けも収録しています。
